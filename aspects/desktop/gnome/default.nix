    ...
    { pkgs, ... }:
    {
      ...
      dconf.settings = with lib.gvariant; {
        ...
        "org/gnome/desktop/wm/keybindings" = {
          ...
          # Free up <Super><Shift><Alt> arrows for Tiling Shell
        ...
        "org/gnome/shell/extensions/tilingshell" = {
          ...
          focus-window-right = [ "<Ctrl><Shift><Alt>Right" ];
          focus-window-left = [ "<Ctrl><Shift><Alt>Left" ];
          focus-window-up = [ "<Ctrl><Shift><Alt>Up" ];
          focus-window-down = [ "<Ctrl><Shift><Alt>Down" ];
        };
        ...
        "org/gnome/shell/extensions/space-bar/shortcuts" = {
          move-workspace-left = mkEmptyArray type.string;
          move-workspace-right = mkEmptyArray type.string;
          activate-previous-key = mkEmptyArray type.string;
        };

        "org/gnome/shell/extensions/rectangle" = {
          animate-movement = false;
        };
