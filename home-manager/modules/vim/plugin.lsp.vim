...
local on_attach = function(client, bufnr)
  ...
  vim.keymap.set('n', '<space>t', function() vim.lsp.buf.format { async = true } end, bufopts)
end
...
local servers = {  'pyright', 'tsserver','jsonnet_ls', 'bufls', 'marksman', 'jsonls', 'clangd', 'nixd' }
